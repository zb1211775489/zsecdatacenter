 ...
 * @Date 2021/3/11
 **/
public class ReaNatFishingBoatRealSink {

    private static final String TOPIC_NAME="rea-fishing-boat";
    private static final String TABLE_NAME="hb_rea_nat_fishing_boat_real";

    public static void main(String[] args) throws Exception {

        String className = ReaNatFishingBoatRealSink.class.getName();
        ...
        props.setProperty("group.id", "rea-nat-fishing-boat-real-group");
        ...
        mainStreaming
        .map(new MapFunction<String, ReaNatFishingBoatRealHTable>() {
            @Override
            public ReaNatFishingBoatRealHTable map(String s) throws Exception {
                ...
                return JSONObject.parseObject(jsonObject.toJSONString(), ReaNatFishingBoatRealHTable.class);
            }
        }).map(new MapFunction<ReaNatFishingBoatRealHTable, Put>() {
            @Override
            public Put map(ReaNatFishingBoatRealHTable put) throws Exception {
                return HbaseUtils.getPut(put);
            }
        }).addSink(new HbaseRichSinkFunction(TABLE_NAME));

        env.execute("ReaNatFishingBoatRealSink");
    }
