 ...
 * @Date 2021/3/11
 **/
public class NewFhgcResSRfkwlvSink {

    private static final String TOPIC_NAME="new-fhgc-res-s-rfkwlv";
    private static final String TABLE_NAME="hb_new_fhgc_res_s_rfkwlv";

    public static void main(String[] args) throws Exception {

        String className = NewFhgcResSRfkwlvSink.class.getName();
        ...
        props.setProperty("group.id", "new-fhgc-res-s-rfkwlv-group");
        ...
        env.execute("NewFhgcResSRfkwlvSink");
    }
}
