...
import com.bayee.hbase.htable.impl.juban.AisInfoHTable;
 ...
 * @Date 2021/3/11
 **/
public class AisInfoSink {

    private static final String TOPIC_NAME="ais-info";
    private static final String TABLE_NAME="hb_ais_info";

    public static void main(String[] args) throws Exception {

        String className = AisInfoSink.class.getName();
        ...
        props.setProperty("group.id", "flink2hbase_group");
        ...
        mainStreaming
        .map(new MapFunction<String, AisInfoHTable>() {
            @Override
            public AisInfoHTable map(String s) throws Exception {
                return JSONObject.parseObject(s, AisInfoHTable.class);
            }
        }).map(new MapFunction<AisInfoHTable, Put>() {
            @Override
            public Put map(AisInfoHTable put) throws Exception {
