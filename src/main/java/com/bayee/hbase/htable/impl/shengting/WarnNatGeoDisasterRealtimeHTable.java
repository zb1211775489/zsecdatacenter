...
/**
 * @ClassName WarnNatGeoDisasterRealtimeHTable
 * @Description: TODO
 * @Author Lyb
 * @Date 2021/4/8
 **/
...
@Setter
@ToString
public class WarnNatGeoDisasterRealtimeHTable implements HTableInterface {
    private int id;
    ...
    private int g1_affected_family_count;
    private int g1_affected_count;
    private int g2_affected_family_count;
    private int g2_affected_count;
    private int g3_affected_family_count;
    private int g3_affected_count;
